              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li
                   >
                    <a class="sidenav-item-link" href="{{ route('item') }}">
                      ...
                      <span class="nav-text">Dishpatch</span>
                    </a>
                  </li>
                  ...
                  >
                   <a class="sidenav-item-link" href="index.html">
                     <i class="mdi mdi-briefcase-account-outline"></i>
                     <span class="nav-text"> Lorry Receipt</span>
                   </a>
                 </li>
                  ...
                  <li
                   >
                    <a class="sidenav-item-link" href="chat.html">
                      ...
                      <span class="nav-text">Arrival</span>
                    </a>
                  </li>
                  ...
                  >
                   <a class="sidenav-item-link" href="calendar.html">
                     <i class="mdi mdi-calendar-check"></i>
                     <span class="nav-text">Check Consignment</span>
                   </a>
                 </li>
                 ...
                 >
                  <a class="sidenav-item-link" href="calendar.html">
                    <i class="mdi mdi-calendar-check"></i>
                    <span class="nav-text">Cancel Booking</span>
                  </a>
                </li>
                ...
                <a class="sidenav-item-link" href="calendar.html">
                  ...
                  {{-- <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#email"
                      ...
                      <span class="nav-text">Check Consignment</span> <b class="caret"></b>
                    </a>
